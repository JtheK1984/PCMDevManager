...
type
  ...
  Tfrm_Config = class(TForm)
    ...
    grpbx_DelphiDetail: TcxGroupBox;
    edt_Projectname: TcxDBTextEdit;
    lbl_Projectname: TcxLabel;
    lbl_Projectpath: TcxLabel;
    edt_Projectpath: TcxDBButtonEdit;
    lbl_ProjectMSBuild: TcxLabel;
    edt_ProjectMSBuild: TcxDBButtonEdit;
    ts_Git: TcxTabSheet;
    grpbx_Git: TcxGroupBox;
    grd_Git: TcxGrid;
    ...
    grpbx_GitDetail: TcxGroupBox;
    edt_Scriptname: TcxDBTextEdit;
    img_GitLogo: TcxDBImage;
    lbl_Scriptname: TcxLabel;
    lbl_Scriptpath: TcxLabel;
    lbl_GitLogo: TcxLabel;
    ...
    lbl_Licence: TcxLabel;
    chkbx_Licence: TcxDBCheckBox;
    grdDBTblViewCol_LocalizeDelphi: TcxGridDBColumn;
    lbl_Language: TcxLabel;
    chkbx_Language: TcxDBCheckBox;
    grpbx_DelphiIcon: TcxGroupBox;
    img_DelphiLogo: TcxDBImage;
    lbl_DelphiLogo: TcxLabel;
    grpbx_DelphiDetails: TcxGroupBox;
    grpbx_DetailChkbx: TcxGroupBox;
    grpbx_GitIcon: TcxGroupBox;
    grpbx_GitDetails: TcxGroupBox;
    grpbx_Detaillbl: TcxGroupBox;
    cxGroupBox1: TcxGroupBox;
    cxGroupBox2: TcxGroupBox;
    img_ConfigHelpprogsLogo: TcxDBImage;
    lbl_helpprogsLogo: TcxLabel;
    ...
    ts_RestConfig: TcxTabSheet;
    dxBarDockControl1: TdxBarDockControl;
    tb_Rest: TdxBar;
    grpbx_RestConfig: TcxGroupBox;
    lbl_Type: TcxLabel;
    lbl_BaseUrl: TcxLabel;
    lbl_Port: TcxLabel;
    btn_RestSave: TdxBarLargeButton;
    grpbx_authConfig: TcxGroupBox;
    lbl_Benutzer: TcxLabel;
    lbl_Passwort: TcxLabel;
