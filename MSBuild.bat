...
msbuild E:/Projekte/Windows/PCMDevmanager/PCMDEVManager.dproj /t:Clean;Build;Localize;CompressWin32 /p:config=Release /p:platform=Win32
msbuild E:/Projekte/Windows/PCMDevmanager/PCMDEVManager.dproj /t:Clean;Build;Localize;CompressWin64 /p:config=Release /p:platform=Win64
...
copy /y /v E:\Projekte\Windows\PCMDevmanager\Win32\Release\PCMDEVManager.DE "e:\Inno\Setupfiles\Programme\PCMDEVManager"
copy /y /v E:\Projekte\Windows\PCMDevmanager\Win32\Release\PCMDEVManager.EN "e:\Inno\Setupfiles\Programme\PCMDEVManager"
